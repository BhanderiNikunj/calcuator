            ...
            children: [
                    ...
                    children: [
                      ...
                      SingleChildScrollView(
                        scrollDirection: Axis.horizontal,
                          child: Align(alignment: Alignment.centerRight,child: Text("$OR Rs.", style: TextStyle(fontSize: 15)))),
                    ],
                  ),
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      //SizedBox(width: 75,),
                      Align(alignment: Alignment.centerRight,child: Text("$FP Rs.", style: TextStyle(fontSize: 15))),
                    ],
                  ),
                ),
              ),
              Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    Text("CGST  :=   ${Rate / 2}", style: TextStyle(fontSize: 15)),
                    Text("SGST  :=   ${Rate / 2}", style: TextStyle(fontSize: 15)),
                  ],
                ),
              ),
              SizedBox(
